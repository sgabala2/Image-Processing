...
// Create an Image of specified dimensions with default RGBA values of 0.
// Parameters: width and height of image to be created
// Returns: NULL if the Image can't be created, pointer to created Image otherwise
...
// Duplicates passed Image.
// Parameters: img: Image to be duplicated
// Returns: pointer to duplicated Image
...
// Parameters: img: Image to be freed
...
// Reads a PNG file
// Only true-color (24 bit color) PNG files are supported.
// Parameters: filename: name of file that image will be read from  
// Returns: pointer to an Image containing the image data, NULL otherwise
...
// Parameters: 
//        img: image to be written, filename: PNG file for image to be written to 
...
// Unpacks a 32-bit pixel value into red, green, blue, and alpha values,  
// stores values in passed pointers
...
// Packs red, green, blue, and alpha component values into a single
// 32-bit value,
// Checks that all component values are less than 256
// Parameters: 
//        r: red component, bits 0-7
//        g: green component, bits 8-15
//        b: blue component, bits 16-23
//        a: alpha component, bits 24-31
//Returns single 32-bit RGBA value
